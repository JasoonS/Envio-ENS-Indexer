...
ETHRegistrarControllerContract_NameRegistered_loader(({ event: _, context }) => {
...
BaseRegistrarContract_NameRegistered_loader(({ event: _, context }) => {
  context.EthRegistrarControllerEventSummary.load(GLOBAL_EVENTS_SUMMARY_KEY);
});
...
BaseRegistrarContract_NameRenewed_loader(({ event: _, context }) => {
  context.EthRegistrarControllerEventSummary.load(GLOBAL_EVENTS_SUMMARY_KEY);
});
...
BaseRegistrarContract_Transfer_loader(({ event: _, context }) => {
  context.EthRegistrarControllerEventSummary.load(GLOBAL_EVENTS_SUMMARY_KEY);
});
...
EthRegistrarControllerOldContract_NameRegistered_loader(({ event: _, context }) => {
  context.EthRegistrarControllerEventSummary.load(GLOBAL_EVENTS_SUMMARY_KEY);
});
...
EthRegistrarControllerOldContract_NameRenewed_loader(({ event: _, context }) => {
  context.EthRegistrarControllerEventSummary.load(GLOBAL_EVENTS_SUMMARY_KEY);
});
