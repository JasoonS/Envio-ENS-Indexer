...
NameWrapperContract_FusesSet_loader(({ event: _, context }) => {
  context.NameWrapperEventsSummary.load(GLOBAL_EVENTS_SUMMARY_KEY_2);
});
...
NameWrapperContract_OwnershipTransferred_loader(({ event: _, context }) => {
  context.NameWrapperEventsSummary.load(GLOBAL_EVENTS_SUMMARY_KEY_2);
});
...
NameWrapperContract_TransferBatch_loader(({ event: _, context }) => {
  context.NameWrapperEventsSummary.load(GLOBAL_EVENTS_SUMMARY_KEY_2);
});
...
NameWrapperContract_TransferSingle_loader(({ event: _, context }) => {
  context.NameWrapperEventsSummary.load(GLOBAL_EVENTS_SUMMARY_KEY_2);
});
